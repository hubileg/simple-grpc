                ...
                <execution>
                    ...
                    <configuration>
                        <protocPlugins>
                            <protocPlugin>
                                <id>simple-grpc</id>
                                <groupId>pl.hubleg</groupId>
                                <artifactId>simple-grpc-generator</artifactId>
                                <version>${simple-grpc.version}</version>
                                <mainClass>pl.hubleg.grpc.simple.SimpleGrpcGenerator</mainClass>
                            </protocPlugin>
                        </protocPlugins>
                    </configuration>
                </execution>
...
> Could not find artifact pl.hubleg:simple-grpc:jar:tests:0.0.1-SNAPSHOT
